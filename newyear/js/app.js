...
$(document).ready(function(){   
    ...
    //春节倒计时
    var starttime = new Date("2023/1/22");
    setInterval(function () {
        ...
        $('.time').html("<p>新的一年倒计时</p>" + "<p><span>" + day + "</span>" + "天</p>");
        $(".sydate").html(syday);
    ...
    var mess = "<span>时间管理大师</span><span class='B-span2'>祝你，新年进步！</span><span>新的一年，要加油呀~</span>";
    $(".Barrage").append(mess);
    ...
    $(".buts").click(function(){
        ...
        if(!mes){
          // alert("你还没输入内容呢!")
          var Tipss = "<div class='Tipss'>主人，您还没输入内容呢</div>";
          $("body").append(Tipss);
          setTimeout(function(){
            $(".Tipss").remove();
          },1500)
    ...
    var this_url=window.location.href;
        ...
        wx.ready(function () {   //需在用户可能点击分享按钮前就先调用
            ...
            wx.updateAppMessageShareData({ 
                ...
                desc: '你好, 2023, 新年快乐！ 春节倒计时, 一大波弹幕正在来袭！！', // 分享描述
